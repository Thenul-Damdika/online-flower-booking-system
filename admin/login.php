...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($username === "" || $password === "") {
        ...
        // Fetch admin credentials using prepared statements
        $stmt = $conn->prepare(
        ...
        <div class="admin-auth-wrapper">
            ...
            <div class="admin-auth-image">
                <div class="admin-auth-image-content">
                    <h2>Welcome Back</h2>
                    <p>Your favourite blooms are waiting for you. Sign in and continue creating beautiful moments with Bloom Heaven.</p>
                </div>
            </div>
            ...
            <div class="admin-auth-form">
                ...
                <form method="POST">
                    <div class="admin-form-group">
                        ...
                        <input type="text" id="username" name="username" class="admin-input-control" placeholder="Enter username or email" required autocomplete="off">
                    </div>
                    ...
                    <button type="submit" class="admin-btn-submit">Login to Account</button>
                </form>
